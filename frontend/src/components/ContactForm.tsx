/**
 * 🏗️  DEVELOPMENT GUIDE - Contact Form Component
 * 
 ...
 * - initialData?: Partial<Contact> (for edit mode)
 * - onCancel?: () => void
 * - isLoading?: boolean
...
const ContactForm: React.FC<ContactFormProps> = ({ onSubmit }) => {
  ...
  return (
    <div className='mid-container'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='lg:w-3/4 mx-auto pb-12'>
        <div className='text-center mb-5 grid grid-cols-2 gap-5'>
          <input
            type="text"
        ...
        <div className='text-center w-full h-40'>
          <textarea
            className="textarea w-full mr-5 h-full"
