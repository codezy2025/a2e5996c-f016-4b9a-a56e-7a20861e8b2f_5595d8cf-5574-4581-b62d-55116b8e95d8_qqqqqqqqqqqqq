/**
 * 🏗️  DEVELOPMENT GUIDE - Home Types
 * 
 ...
 * - Create utility types for API responses (ApiResponse<Home>)
 ...
 * 
 * 💡 Example Extensions:
 * - export enum HomeStatus { ACTIVE = 'active', INACTIVE = 'inactive' }
 * - export type HomeSearchParams = Pick<Home, 'name' | 'status'>
 * - export type HomeUpdateData = Partial<Omit<Home, 'id' | 'createdAt'>>
 */
