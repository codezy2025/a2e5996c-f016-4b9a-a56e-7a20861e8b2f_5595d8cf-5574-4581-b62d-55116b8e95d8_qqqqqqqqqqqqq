/**
 * 🏗️  DEVELOPMENT GUIDE - Contact Types
 * 
 ...
 * - Create utility types for API responses (ApiResponse<Contact>)
 ...
 * - export type ContactSearchParams = Pick<Contact, 'name' | 'status'>
 * - export type ContactUpdateData = Partial<Omit<Contact, 'id' | 'createdAt'>>
 */
