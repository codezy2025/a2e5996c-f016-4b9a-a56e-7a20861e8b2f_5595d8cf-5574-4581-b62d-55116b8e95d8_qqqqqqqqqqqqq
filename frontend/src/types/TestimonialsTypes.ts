/**
 * 🏗️  DEVELOPMENT GUIDE - Testimonials Types
 * 
 ...
 * - Create utility types for API responses (ApiResponse<Testimonials>)
 ...
 * 
 * 💡 Example Extensions:
 * - export enum TestimonialsStatus { ACTIVE = 'active', INACTIVE = 'inactive' }
 * - export type TestimonialsSearchParams = Pick<Testimonials, 'name' | 'status'>
 * - export type TestimonialsUpdateData = Partial<Omit<Testimonials, 'id' | 'createdAt'>>
 */
