/**
 * 🏗️  DEVELOPMENT GUIDE - Navbar Types
 * 
 ...
 * - Create utility types for API responses (ApiResponse<Navbar>)
 ...
 * 
 * 💡 Example Extensions:
 * - export enum NavbarStatus { ACTIVE = 'active', INACTIVE = 'inactive' }
 * - export type NavbarSearchParams = Pick<Navbar, 'name' | 'status'>
 * - export type NavbarUpdateData = Partial<Omit<Navbar, 'id' | 'createdAt'>>
 */
